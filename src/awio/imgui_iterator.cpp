/*
* This file is generated from https://github.com/patrickriordan/imgui_lua_bindings
*/
//struct ImVec2
...
// Unsupported return type ImGuiWindow*
//    IMGUI_API ImGuiWindow*  FindWindowByName(const char* name);
// Unsupported return type ImGuiWindow*
//    IMGUI_API void          FocusWindow(ImGuiWindow* window);
// Unsupported arg type ImGuiWindow* window
...
IMGUI_FUNCTION(SetHoveredID)
UINT_ARG(id)
CALL_FUNCTION_NO_RET(SetHoveredID, id)
END_IMGUI_FUNC
//    IMGUI_API void          KeepAliveID(ImGuiID id);
IMGUI_FUNCTION(KeepAliveID)
UINT_ARG(id)
CALL_FUNCTION_NO_RET(KeepAliveID, id)
END_IMGUI_FUNC
//    IMGUI_API void          ItemSize(const ImVec2& size, float text_offset_y = 0.0f);
IMGUI_FUNCTION(ItemSize)
IM_VEC_2_ARG(size)
OPTIONAL_NUMBER_ARG(text_offset_y, 0.0f)
CALL_FUNCTION_NO_RET(ItemSize, size, text_offset_y)
END_IMGUI_FUNC
//    IMGUI_API void          ItemSize(const ImRect& bb, float text_offset_y = 0.0f);
// Unsupported arg type const ImRect& bb
//    IMGUI_API bool          ItemAdd(const ImRect& bb, const ImGuiID* id);
// Unsupported arg type const ImRect& bb
// Unsupported arg type  const ImGuiID* id
...
IMGUI_FUNCTION(CalcItemSize)
IM_VEC_2_ARG(size)
NUMBER_ARG(default_x)
NUMBER_ARG(default_y)
CALL_FUNCTION(CalcItemSize, ImVec2, size, default_x, default_y)
PUSH_NUMBER(ret.x)
PUSH_NUMBER(ret.y)
END_IMGUI_FUNC
//    IMGUI_API float         CalcWrapWidthForPos(const ImVec2& pos, float wrap_pos_x);
IMGUI_FUNCTION(CalcWrapWidthForPos)
IM_VEC_2_ARG(pos)
NUMBER_ARG(wrap_pos_x)
CALL_FUNCTION(CalcWrapWidthForPos, float, pos, wrap_pos_x)
PUSH_NUMBER(ret)
END_IMGUI_FUNC
//    IMGUI_API void          OpenPopupEx(const char* str_id, bool reopen_existing);
IMGUI_FUNCTION(OpenPopupEx)
LABEL_ARG(str_id)
BOOL_ARG(reopen_existing)
CALL_FUNCTION_NO_RET(OpenPopupEx, str_id, reopen_existing)
END_IMGUI_FUNC
//    IMGUI_API void          RenderText(ImVec2 pos, const char* text, const char* text_end = NULL, bool hide_text_after_hash = true);
IMGUI_FUNCTION(RenderText)
IM_VEC_2_ARG(pos)
LABEL_ARG(text)
OPTIONAL_LABEL_ARG(text_end)
OPTIONAL_BOOL_ARG(hide_text_after_hash, true)
CALL_FUNCTION_NO_RET(RenderText, pos, text, text_end, hide_text_after_hash)
END_IMGUI_FUNC
//    IMGUI_API void          RenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width);
IMGUI_FUNCTION(RenderTextWrapped)
IM_VEC_2_ARG(pos)
LABEL_ARG(text)
LABEL_ARG(text_end)
NUMBER_ARG(wrap_width)
CALL_FUNCTION_NO_RET(RenderTextWrapped, pos, text, text_end, wrap_width)
END_IMGUI_FUNC
//    IMGUI_API void          RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2 0 0, const ImRect* clip_rect = NULL);
// Unsupported arg type  const ImVec2* text_size_if_known
// Unsupported arg type  const ImRect* clip_rect = NULL
//    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f);
IMGUI_FUNCTION(RenderFrame)
IM_VEC_2_ARG(p_min)
IM_VEC_2_ARG(p_max)
UINT_ARG(fill_col)
OPTIONAL_BOOL_ARG(border, true)
OPTIONAL_NUMBER_ARG(rounding, 0.0f)
CALL_FUNCTION_NO_RET(RenderFrame, p_min, p_max, fill_col, border, rounding)
END_IMGUI_FUNC
//    IMGUI_API void          RenderCollapseTriangle(ImVec2 pos, bool is_open, float scale = 1.0f);
IMGUI_FUNCTION(RenderCollapseTriangle)
IM_VEC_2_ARG(pos)
BOOL_ARG(is_open)
OPTIONAL_NUMBER_ARG(scale, 1.0f)
CALL_FUNCTION_NO_RET(RenderCollapseTriangle, pos, is_open, scale)
END_IMGUI_FUNC
//    IMGUI_API void          RenderBullet(ImVec2 pos);
IMGUI_FUNCTION(RenderBullet)
IM_VEC_2_ARG(pos)
CALL_FUNCTION_NO_RET(RenderBullet, pos)
END_IMGUI_FUNC
//    IMGUI_API void          RenderCheckMark(ImVec2 pos, ImU32 col);
IMGUI_FUNCTION(RenderCheckMark)
IM_VEC_2_ARG(pos)
UINT_ARG(col)
CALL_FUNCTION_NO_RET(RenderCheckMark, pos, col)
END_IMGUI_FUNC
...
IMGUI_FUNCTION(CloseButton)
UINT_ARG(id)
IM_VEC_2_ARG(pos)
NUMBER_ARG(radius)
CALL_FUNCTION(CloseButton, bool, id, pos, radius)
PUSH_BOOL(ret)
END_IMGUI_FUNC
//    IMGUI_API bool          SliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags = 0);
// Unsupported arg type const ImRect& frame_bb
// Unsupported arg type  ImGuiSliderFlags flags = 0
//    IMGUI_API bool          SliderFloatN(const char* label, float* v, int components, float v_min, float v_max, const char* display_format, float power);
IMGUI_FUNCTION(SliderFloatN)
LABEL_ARG(label)
FLOAT_POINTER_ARG(v)
INT_ARG(components)
NUMBER_ARG(v_min)
...
LABEL_ARG(display_format)
NUMBER_ARG(power)
CALL_FUNCTION(SliderFloatN, bool, label, v, components, v_min, v_max, display_format, power)
PUSH_BOOL(ret)
END_FLOAT_POINTER(v)
END_IMGUI_FUNC
//    IMGUI_API bool          SliderIntN(const char* label, int* v, int components, int v_min, int v_max, const char* display_format);
IMGUI_FUNCTION(SliderIntN)
LABEL_ARG(label)
INT_POINTER_ARG(v)
INT_ARG(components)
INT_ARG(v_min)
INT_ARG(v_max)
LABEL_ARG(display_format)
CALL_FUNCTION(SliderIntN, bool, label, v, components, v_min, v_max, display_format)
PUSH_BOOL(ret)
END_INT_POINTER(v)
END_IMGUI_FUNC
...
LABEL_ARG(display_format)
NUMBER_ARG(power)
CALL_FUNCTION(DragFloatN, bool, label, v, components, v_speed, v_min, v_max, display_format, power)
PUSH_BOOL(ret)
END_FLOAT_POINTER(v)
END_IMGUI_FUNC
//    IMGUI_API bool          DragIntN(const char* label, int* v, int components, float v_speed, int v_min, int v_max, const char* display_format);
IMGUI_FUNCTION(DragIntN)
LABEL_ARG(label)
INT_POINTER_ARG(v)
INT_ARG(components)
NUMBER_ARG(v_speed)
...
INT_ARG(v_max)
LABEL_ARG(display_format)
CALL_FUNCTION(DragIntN, bool, label, v, components, v_speed, v_min, v_max, display_format)
PUSH_BOOL(ret)
END_INT_POINTER(v)
END_IMGUI_FUNC
...
IMGUI_FUNCTION(InputFloatN)
LABEL_ARG(label)
FLOAT_POINTER_ARG(v)
INT_ARG(components)
INT_ARG(decimal_precision)
INT_ARG(extra_flags)
CALL_FUNCTION(InputFloatN, bool, label, v, components, decimal_precision, extra_flags)
PUSH_BOOL(ret)
END_FLOAT_POINTER(v)
END_IMGUI_FUNC
//    IMGUI_API bool          InputIntN(const char* label, int* v, int components, ImGuiInputTextFlags extra_flags);
IMGUI_FUNCTION(InputIntN)
LABEL_ARG(label)
INT_POINTER_ARG(v)
INT_ARG(components)
INT_ARG(extra_flags)
CALL_FUNCTION(InputIntN, bool, label, v, components, extra_flags)
PUSH_BOOL(ret)
END_INT_POINTER(v)
END_IMGUI_FUNC
//    IMGUI_API bool          InputScalarEx(const char* label, ImGuiDataType data_type, void* data_ptr, void* step_ptr, void* step_fast_ptr, const char* scalar_format, ImGuiInputTextFlags extra_flags);
// Unsupported arg type  ImGuiDataType data_type
// Unsupported arg type  void* data_ptr
// Unsupported arg type  void* step_ptr
// Unsupported arg type  void* step_fast_ptr
//    IMGUI_API bool          InputScalarAsWidgetReplacement(const ImRect& aabb, const char* label, ImGuiDataType data_type, void* data_ptr, ImGuiID id, int decimal_precision);
// Unsupported arg type const ImRect& aabb
// Unsupported arg type  ImGuiDataType data_type
// Unsupported arg type  void* data_ptr
...
IMGUI_FUNCTION(TreePushRawID)
UINT_ARG(id)
CALL_FUNCTION_NO_RET(TreePushRawID, id)
END_IMGUI_FUNC
//    IMGUI_API void          PlotEx(ImGuiPlotType plot_type, const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 graph_size);
// Unsupported arg type ImGuiPlotType plot_type
// Unsupported arg type  float (*values_getter)(void* data
// Unsupported arg type  void* data
//    IMGUI_API int           ParseFormatPrecision(const char* fmt, int default_value);
// Unsupported return type int
//    IMGUI_API float         RoundScalar(float value, int decimal_precision);
IMGUI_FUNCTION(RoundScalar)
NUMBER_ARG(value)
INT_ARG(decimal_precision)
CALL_FUNCTION(RoundScalar, float, value, decimal_precision)
PUSH_NUMBER(ret)
END_IMGUI_FUNC
END_STACK_START
